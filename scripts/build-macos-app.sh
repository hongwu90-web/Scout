...
(
  cd "$DIST_DIR"
  rm -f Scout-macOS-arm64.zip Scout-v1.47-macOS-arm64.zip Scout-v1.46-macOS-arm64.zip Scout-v1.45-macOS-arm64.zip Scout-v1.40-macOS-arm64.zip Scout-v1.33-macOS-arm64.zip Scout-v1.32-macOS-arm64.zip Scout-v1.31-macOS-arm64.zip Scout-v1.30-macOS-arm64.zip Scout-v1.20-macOS-arm64.zip
  zip -r -q Scout-v1.47-macOS-arm64.zip "$APP_NAME.app"
  cp Scout-v1.47-macOS-arm64.zip Scout-macOS-arm64.zip
)

echo "==> Done! Application bundle created at: $APP_DIR"
echo "==> Zip archive created at: $DIST_DIR/Scout-v1.47-macOS-arm64.zip"
